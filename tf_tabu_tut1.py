import keras.feature_column.dense_features
import numpy as np
import pandas as pd
import tensorflow
...
# 组合的特征列
crossed_feature = feature_column.crossed_column([age_buckets, animal_type],
                                                hash_bucket_size=10)
...
# crossed columns
age_type_feature = feature_column.crossed_column([age_buckets, animal_type],
